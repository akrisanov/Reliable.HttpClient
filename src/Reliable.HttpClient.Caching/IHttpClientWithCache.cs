...
public interface IHttpClientWithCache
{
    ...
    /// <summary>
    /// Performs GET request with caching support and custom headers
    /// </summary>
    /// <typeparam name="TResponse">Response type after deserialization</typeparam>
    /// <param name="requestUri">Request URI</param>
    ...
    /// <summary>
    /// Performs POST request with custom headers (not cached, invalidates related cache entries)
    /// </summary>
    /// <typeparam name="TRequest">Request content type</typeparam>
    /// <typeparam name="TResponse">Response type after deserialization</typeparam>
    /// <param name="requestUri">Request URI</param>
    ...
    /// <summary>
    /// Performs PUT request with custom headers (not cached, invalidates related cache entries)
    /// </summary>
    /// <typeparam name="TRequest">Request content type</typeparam>
    /// <typeparam name="TResponse">Response type after deserialization</typeparam>
    /// <param name="requestUri">Request URI</param>
    ...
    /// <summary>
    /// Performs DELETE request with custom headers (not cached, invalidates related cache entries)
    /// </summary>
    /// <typeparam name="TResponse">Response type after deserialization</typeparam>
    /// <param name="requestUri">Request URI</param>
    /// <param name="headers">Custom headers to add to the request</param>
